...
function main()
    ...
    σₚ = pointstate(space, SymmetricTensor{2,3,Float64})
    Fₚ = pointstate(space, Tensor{2,3,Float64})
    ∇vₚ = pointstate(space, Tensor{2,3,Float64})
    fill!(Fₚ, one(Tensor{2,3,Float64}))
