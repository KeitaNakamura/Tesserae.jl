...
@test mean(contacting_grains(QuadraticBSpline(),                   FLIP(); test=true).x) ≈ [0.4985004093012896, 0.18855426699514896] rtol=1e-5 #src
@test mean(contacting_grains(uGIMP(),                              FLIP(); test=true).x) ≈ [0.4994968833949179, 0.19356014221942383] rtol=1e-5 #src
@test mean(contacting_grains(KernelCorrection(QuadraticBSpline()), TPIC(); test=true).x) ≈ [0.498623629012239, 0.18802427884752393]  rtol=1e-5 #src
end                                                                                                                                            #src
